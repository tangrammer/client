...
{{
var G__5626 = cljs.core.pop.call(null,v__$1);
v__$1 = G__5626;
continue;
}
} else
...
{var pred__5630 = cljs.core._EQ_;var expr__5631 = limit;if(pred__5630.call(null,1,expr__5631))
{return cljs.core.vector.call(null,s);
} else
{if(pred__5630.call(null,2,expr__5631))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__5633 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__5634 = (limit__$1 - 1);
var G__5635 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5633;
limit__$1 = G__5634;
parts = G__5635;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___5637 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___5637))
{var replacement_5638 = temp__4090__auto___5637;buffer.append([cljs.core.str(replacement_5638)].join(''));
} else
{buffer.append(ch);
}
{
