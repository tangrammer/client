...
{var x__4935__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.read_char[goog.typeOf(x__4935__auto__)]);if(or__3943__auto__)
...
{var x__4935__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.unread[goog.typeOf(x__4935__auto__)]);if(or__3943__auto__)
{return or__3943__auto__;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__4876__auto__,writer__4877__auto__,opt__4878__auto__){return cljs.core._write.call(null,writer__4877__auto__,"cljs.reader/StringPushbackReader");
});
...
reader_error.cljs$lang$applyTo = (function (arglist__5595){
var rdr = cljs.core.first(arglist__5595);
var msg = cljs.core.rest(arglist__5595);
...
{{
var G__5596 = (function (){sb.append(ch);
return sb;
})();
var G__5597 = cljs.reader.read_char.call(null,rdr);
sb = G__5596;
ch = G__5597;
continue;
}
...
{{
var G__5598 = cljs.reader.read_char.call(null,rdr);
ch = G__5598;
continue;
}
} else
...
var G__5599 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__5599;
continue;
}
} else
...
var G__5600 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__5600;
continue;
}
}
...
{{
var G__5601 = (function (){buffer.append(ch);
return buffer;
})();
var G__5602 = cljs.reader.read_char.call(null,reader);
buffer = G__5601;
ch = G__5602;
continue;
}
...
{if(("\\" === ch))
{{
var G__5603 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__5604 = cljs.reader.read_char.call(null,reader);
buffer = G__5603;
ch = G__5604;
continue;
}
...
{{
var G__5605 = (function (){buffer.append(ch);
return buffer;
})();
var G__5606 = cljs.reader.read_char.call(null,reader);
buffer = G__5605;
ch = G__5606;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__5608 = o;if(G__5608)
{if((function (){var or__3943__auto__ = (G__5608.cljs$lang$protocol_mask$partition0$ & 262144);if(or__3943__auto__)
{return or__3943__auto__;
} else
{return G__5608.cljs$core$IWithMeta$;
}
})())
{return true;
} else
{if((!G__5608.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__5608);
} else
{return false;
}
}
...
{{
var G__5609 = reader;
var G__5610 = eof_is_error;
var G__5611 = sentinel;
var G__5612 = is_recursive;
reader = G__5609;
eof_is_error = G__5610;
sentinel = G__5611;
is_recursive = G__5612;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__5613 = cljs.reader.read_comment.call(null,reader,ch);
var G__5614 = eof_is_error;
var G__5615 = sentinel;
var G__5616 = is_recursive;
reader = G__5613;
eof_is_error = G__5614;
sentinel = G__5615;
is_recursive = G__5616;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__5617 = reader;
var G__5618 = eof_is_error;
var G__5619 = sentinel;
var G__5620 = is_recursive;
reader = G__5617;
eof_is_error = G__5618;
sentinel = G__5619;
is_recursive = G__5620;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__5623 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__5623,0,null);var years = cljs.core.nth.call(null,vec__5623,1,null);var months = cljs.core.nth.call(null,vec__5623,2,null);var days = cljs.core.nth.call(null,vec__5623,3,null);var hours = cljs.core.nth.call(null,vec__5623,4,null);var minutes = cljs.core.nth.call(null,vec__5623,5,null);var seconds = cljs.core.nth.call(null,vec__5623,6,null);var fraction = cljs.core.nth.call(null,vec__5623,7,null);var offset_sign = cljs.core.nth.call(null,vec__5623,8,null);var offset_hours = cljs.core.nth.call(null,vec__5623,9,null);var offset_minutes = cljs.core.nth.call(null,vec__5623,10,null);var v = vec__5623;if(cljs.core.not.call(null,v))
...
{var vec__5625 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__5625,0,null);var months = cljs.core.nth.call(null,vec__5625,1,null);var days = cljs.core.nth.call(null,vec__5625,2,null);var hours = cljs.core.nth.call(null,vec__5625,3,null);var minutes = cljs.core.nth.call(null,vec__5625,4,null);var seconds = cljs.core.nth.call(null,vec__5625,5,null);var ms = cljs.core.nth.call(null,vec__5625,6,null);var offset = cljs.core.nth.call(null,vec__5625,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
